...
meal_cases = "eval_cases/meal_cases.json"
...
if __name__ == "__main__":
    ...
    # Run meal agent evals
    with open(meal_cases, "r") as file:
        meal_test_cases = json.load(file)
    run_function_evals(
        meal_agent,
        meal_test_cases,
        n,
        eval_path="eval_results/meal_evals.json",
    )
